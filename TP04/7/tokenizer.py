...
class Tokenizer(object):
    ...
    def __init__(self, dir=getcwd(), queries_file=None, stopwords_file=None, stemmer=None, term_min_len=3, term_max_len=50, verbose=False, in_memory_index=False, skip_pointers=False):
        ...
        self._index = IndexIR(self._hash_dir, in_memory_index, skip_pointers)
        self._docs_id = dict()
        self._terms_id = dict()
        self._qty_docs = 0
        self._qty_tokens = 0
