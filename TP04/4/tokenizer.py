...
from indexSpimi import IndexIR
...
DNF = {
    ...
    '1not2': [[1,0]],
    '1and2and3': [[1,1,1]],
    '1or2not3': [[1,1,0], [1,0,0], [0,1,0]],
    '1or2not3': [[1,1,1], [1,0,1], [0,1,1]],
    '1and2or3': [[1,1,0], [1,1,1]],
}
...
class Tokenizer(object):
    ...
    def __init__(self, dir=getcwd(), queries_file=None, stopwords_file=None, stemmer=None, term_min_len=3, term_max_len=50, verbose=False, in_memory_index=False, qty_partial_docs=400):
        ...
        self._index = IndexIR(self._hash_dir, in_memory_index, qty_partial_docs)
        self._docs_id = dict()
        self._terms_id = dict()
        self._qty_docs = 0
        self._qty_tokens = 0
    ...
    def make_queries(self):
        ...
        masks3 = ['1and2and3','1or2not3','1or2not3','1and2or3']
    ...
    def discovery_dir(self, path=None):
        if (not self._index.index_exists()):
            ...
            print(f"Using Partial Docs Qty = {self._qty_partial_docs}")
            print(f"Indexing took {time() - start} secs")
            start = time()
            self._index.indexing_ready()
            print(f"Merging took {time() - start} secs")
